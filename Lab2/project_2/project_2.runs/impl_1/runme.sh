...
HD_PWD='C:/Users/tiago/OneDrive/Desktop/Universidade/Mestrado/PSD/Laboratorios/Lab2/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circuit.tcl -notrace
